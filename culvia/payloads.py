...
def serialize_photo(
    ...
    *,
    image_url: Callable[..., str],
    thumbnail_url: Callable[..., str],
    ...
    return {
        ...
        "fileId": file_id,
        "path": path,
        "image": image_url(path, 1800, file_id=file_id),
        "thumb": thumbnail_url(path, file_id=file_id),
        "preview": image_url(path, 2400, file_id=file_id),
